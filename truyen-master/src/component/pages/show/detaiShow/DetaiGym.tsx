...
import { DataPhongym } from "../showphonggym/Showphonggym";
const DetaiShowPhonggym = () => {
  return (
    <GirdDetaiH2>
      ...
      <div className="girdBackDetail">
        <h2 className="girdH2">Hình ảnh tranh vẽ phòng gym </h2>
      </div>
      <GirdDetail>
...
export default memo(DetaiShowPhonggym);
